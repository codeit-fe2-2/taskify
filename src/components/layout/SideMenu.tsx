...
export default function SideMenu({
	...
	return (
		<aside className='h-screen w-[var(--side-menu-width)] shrink-0  border-r border-gray3 px-3 py-5 scrollbar-hide sm:w-[var(--side-menu-width-sm)] sm:px-3 md:w-[var(--side-menu-width-md)]'>
